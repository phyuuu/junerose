-- Recreate the manual stock workflow after staff-role hardening. The hosted
-- project predates the canonical baseline, so this function may still carry
-- legacy ownership or permission behavior.
